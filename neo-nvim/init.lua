...
-- Keybinds galore
vim.keymap.set("n", "<leader>E", "<cmd>qa!<CR>", { desc = "[E]xit neovim" }) -- quick close nvim without saving

-- Buffer Navigation
vim.keymap.set("n", "<leader>bn", "<cmd>bn<CR>", { desc = "[N]ext buffer" })
vim.keymap.set("n", "<leader>bb", "<cmd>bp<CR>", { desc = "[P]revious buffer" })
vim.keymap.set("n", "<leader>bd", "<cmd>bd<CR>", { desc = "[D]elete buffer" })

-- Editor keymaps
vim.keymap.set({ "n", "v" }, "<leader>v", "", { desc = "Delete to [V]oid register" })
-- in visual, move block down, indent when needed
vim.keymap.set("v", "J", ":m '>+1<CR>gv=gv")
-- in visual, move block up, indent when needed
vim.keymap.set("v", "K", ":m '<-2<CR>gv=gv")
-- half page down, keep cursor in center of buffer
vim.keymap.set("n", "<C-d>", "<C-d>zz")
-- half page up, keep cursor in center of buffer
vim.keymap.set("n", "<C-u>", "<C-u>zz")
-- next search term, keep cursor in center of buffer
vim.keymap.set("n", "n", "nzzzv")
-- previous search term, keep cursor in center of buffer
vim.keymap.set("n", "N", "Nzzzv")
-- yank all in brackets surrounding cursor
...
require("lazy").setup({
	...
	{ -- Fuzzy Finder (files, lsp, etc)
		...
		config = function()
			...
			-- Disable folding in Telescope result windows
