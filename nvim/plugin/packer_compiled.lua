...
_G.packer_plugins = {
  ...
  ["cmp-nvim-lsp-signature-help"] = {
    loaded = true,
    path = "/home/jack/.local/share/nvim/site/pack/packer/start/cmp-nvim-lsp-signature-help",
  ...
  gruvbox = {
    loaded = true,
    path = "/home/jack/.local/share/nvim/site/pack/packer/start/gruvbox",
    url = "https://github.com/gruvbox-community/gruvbox"
  },
  ["gruvbox-flat.nvim"] = {
    loaded = true,
    path = "/home/jack/.local/share/nvim/site/pack/packer/start/gruvbox-flat.nvim",
  ...
  ["nvim-ts-autotag"] = {
    loaded = true,
    path = "/home/jack/.local/share/nvim/site/pack/packer/start/nvim-ts-autotag",
  ...
  ["prettier.nvim"] = {
    loaded = true,
    path = "/home/jack/.local/share/nvim/site/pack/packer/start/prettier.nvim",
